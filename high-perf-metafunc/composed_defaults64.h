#ifndef COMPOSED_DEFAULTS64_H
#define COMPOSED_DEFAULTS64_H

#include "TypeList.h"

/*
the fasttrack version had specialisations for 
2, 4, 16, 64 versions of join causing it a TC of
nlog(n, 4). instead of providing overloads we can use 
default empty typelist so that there are no overloads.

we are doing this because, in the fasttrack version multiple 
instantiations for 2, 4, 16, 64 were needed. but in the defaults
version only one case (64) is instantiated multiple times, improving
the efficiency
...
template <typename ... T0s, typename ... T1s, typename ... T2s, 
          ...
          typename ... T63s>
struct join64<type_list<T0s...>, type_list<T1s...>, type_list<T2s...>, 
...
template <typename L0 = type_list<>, typename L1 = type_list<>, typename L2 = type_list<>,
          typename L3 = type_list<>, typename L4 = type_list<>, typename L5 = type_list<>,
          typename L6 = type_list<>, typename L7 = type_list<>, typename L8 = type_list<>, 
          typename L9 = type_list<>, typename L10 = type_list<>, typename L11 = type_list<>,
          typename L12 = type_list<>, typename L13 = type_list<>, typename L14 = type_list<>,
          typename L15 = type_list<>, typename L16 = type_list<>, typename L17 = type_list<>,
          typename L18 = type_list<>, typename L19 = type_list<>, typename L20 = type_list<>,
          typename L21 = type_list<>, typename L22 = type_list<>, typename L23 = type_list<>,
          typename L24 = type_list<>, typename L25 = type_list<>, typename L26 = type_list<>,
          typename L27 = type_list<>, typename L28 = type_list<>, typename L29 = type_list<>,
          typename L30 = type_list<>, typename L31 = type_list<>, typename L32 = type_list<>,
          typename L33 = type_list<>, typename L34 = type_list<>, typename L35 = type_list<>,
          typename L36 = type_list<>, typename L37 = type_list<>, typename L38 = type_list<>,
          typename L39 = type_list<>, typename L40 = type_list<>, typename L41 = type_list<>,
          typename L42 = type_list<>, typename L43 = type_list<>, typename L44 = type_list<>,
          typename L45 = type_list<>, typename L46 = type_list<>, typename L47 = type_list<>,
          typename L48 = type_list<>, typename L49 = type_list<>, typename L50 = type_list<>,
          typename L51 = type_list<>, typename L52 = type_list<>, typename L53 = type_list<>,
          typename L54 = type_list<>, typename L55 = type_list<>, typename L56 = type_list<>,
          typename L57 = type_list<>, typename L58 = type_list<>, typename L59 = type_list<>,
          typename L60 = type_list<>, typename L61 = type_list<>, typename L62 = type_list<>,
          typename L63 = type_list<>, typename... MORE_LISTS>
struct join {
	using type = typename join<typename detail::join64<L0, L1, L2, L3, L4, L5, L6, L7, L8, L9, L10,
	                                                   L11, L12, L13, L14, L15, L16, L17, L18, L19, 
                                                       L20, L21, L22, L23, L24, L25, L26, L27, L28, 
                                                       L29, L30, L31, L32, L33, L34, L35, L36, L37,
                                                       L38, L39, L40, L41, L42, L43, L44, L45, L46,
	                                                   L47, L48, L49, L50, L51, L52, L53, L54, L55,
	                                                   L56, L57, L58, L59, L60, L61, L62, L63>::type,
	                           MORE_LISTS...>::type;
};
...
========= gcc x 1 ==========
baseline: 1.220s
composed_fasttrack - baseline: 81.660s
composed_defaults - baseline: 40.380s

==> takes 50% less time or 2x fasterr.

but the issue with this approach is that for smaller inputs,
such as for n < 64, then also we are going to instantiate for 64 types
causing more overhead, so some tweaking is needed.
*/

/*
to get more speedup join1024 can also implemented.
*/
...
========= gcc x 1 ==========
baseline: 1.250s
lazy - baseline: 2.670s
composed - baseline: 5.140s
composed_fasttrack - baseline: 0.160s
composed_defaults - baseline: 0.130s

40x faster than the lazy version
*/
